<template>
  <div class="container mx-auto py-16 px-4">
    <div class="max-w-md mx-auto">
      ...
      <div class="shadow-lg border-t-4 border-t-blue-600 bg-white rounded-lg">
        <div class="space-y-1 p-6 border-b bg-gradient-to-r from-blue-50 to-white">
          <h2 class="text-2xl font-bold text-center text-blue-800">Admin Login</h2>
          <p class="text-center text-gray-500">Sign in to access your administration dashboard</p>
        </div>
        <div class="p-6">
