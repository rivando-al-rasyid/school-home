<template>
  <div class="container mx-auto py-16 px-4">
    <div class="max-w-md mx-auto">
      ...
      <div class="shadow-lg border-t-4 border-t-green-600 bg-white rounded-lg">
        <div class="space-y-1 p-6 border-b bg-gradient-to-r from-green-50 to-white">
          <h2 class="text-2xl font-bold text-center text-green-800">Teacher Login</h2>
          <p class="text-center text-gray-500">Sign in to access your teacher dashboard</p>
        </div>
        <div class="p-6">
          <form class="space-y-4" @submit.prevent="handleLogin">
            ...
            <!-- Email -->
            <div class="space-y-2">
              <label for="email" class="text-sm font-medium">Teacher Email</label>
              <input
                id="email"
...
const handleLogin = async () => {
  ...
  try {
    ...
    await api.post('/api/teacher/login', {
